...
const (
	...
	audioChannelCount   = 2
	audioAttack         = 190 * time.Millisecond
	audioRelease        = 720 * time.Millisecond
	...
	audioPeakDecay      = 1100 * time.Millisecond
	audioEventLifetime  = 2500 * time.Millisecond
	audioOnsetCooldown  = 360 * time.Millisecond
	audioRegionCooldown = 520 * time.Millisecond
	audioEventCapacity  = 8
	audioFluxThreshold  = 0.11
	audioBassThreshold  = 0.20
	audioHighThreshold  = 0.20
